...
#CROSS VALIDATION OF LARGE PURCHASE
scores = cross_val_score(clf_op, X, y, scoring="neg_mean_squared_error",
                         cv=10)
clf_mlp_rmse_scores = np.sqrt(-scores)

print('Scores', clf_mlp_rmse_scores)
print('Mean', clf_mlp_rmse_scores.mean()) #4.777
print('SD', clf_mlp_rmse_scores.std())
# Scores [0.         0.         0.         0.         0.00733847 0. 0.         0.         0.
# 0.01037845]
# Mean 0.0017716922184126155
# SD 0.00360799745065882 # extremely good performance across the validation!
...
scores = cross_val_score(clf, X, Y.values.ravel(), scoring="neg_mean_squared_error",
                         cv=10)
clf_mlp_rmse_scores = np.sqrt(-scores)

print('Scores', clf_mlp_rmse_scores)
print('Mean', clf_mlp_rmse_scores.mean())
print('SD', clf_mlp_rmse_scores.std())

# Scores [12.43125098 11.91170372 12.04762392 12.48811595 12.71685714 12.50427252
#  12.52444615 12.08517631 12.25349795 12.40416733]
# Mean 12.336711196026847
# SD 0.2405495175580531
#
#